...
ActiveRecord::Schema.define(version: 20170126223250) do
  ...
  create_table "monsters", force: :cascade do |t|
    ...
    t.string   "img",         default: "https://www.acefitness.org/myace/images/contactimage/no_phototn.jpg"
    t.text     "description"
    t.string   "email"
  ...
  create_table "reviews", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["monster_id"], name: "index_reviews_on_monster_id", using: :btree
